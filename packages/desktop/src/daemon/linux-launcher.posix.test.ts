...
async function launch(
  ...
  try {
    ...
    chmodSync(join(app, "Odusphere"), 0o755);
    ...
    const executablePath = options.symlink ? join(root, "paseo") : join(app, "Odusphere");
    if (options.symlink) symlinkSync(join(app, "Odusphere"), executablePath);
    ...
    const result = spawnSync(executablePath, args, {
      ...
      env: {
        ...
        APPIMAGE: "/tmp/Odusphere.AppImage",
