...
export const ja: TranslationResources = {
  ...
  agentStream: {
    ...
    find: {
      ...
      next: "次の一致",
      previous: "前の一致",
      count: "{{total}} 件中 {{position}} 件目",
      countTruncated: "{{total}}+ 件中 {{position}} 件目",
      noMatches: "一致なし",
      failed: "検索に失敗しました",
      kind: {
        user_message: "あなた",
        assistant_message: "エージェント",
        reasoning: "思考",
        error: "エラー",
        tool_call: "ツール呼び出し",
      },
    ...
    git: {
      actions: {
        ...
        unavailable: {
          ...
          archiveNotWorktree:
            "このワークスペースはOdusphereワークツリーとして作成されていないため、アーカイブはここでは利用できません",
  ...
  desktop: {
    ...
    daemon: {
      ...
      management: {
        title: "組み込みデーモンを管理",
        hint: "Odusphereが組み込みデーモンを起動・停止できるようにする",
        pauseTitle: "組み込みデーモンを一時停止",
        pauseMessage:
          "これにより組み込みデーモンが即座に停止します。組み込みデーモンに接続されている実行中のエージェントとターミナルが停止されます。",
        pauseAndStop: "一時停止して停止",
        registrationFailed:
          "組み込みデーモンは起動しましたが、Odusphereがlocalhostの接続を保存できませんでした。デーモン管理をオフにしてから再度オンにするか、localhostを手動で追加してください。",
        pausedStopFailed:
          "組み込みデーモン管理は一時停止されましたが、Odusphereがデーモンを停止できませんでした。",
        updateFailed: "組み込みデーモン管理を更新できません。",
      },
      keepRunning: {
        title: "終了後もデーモンを実行し続ける",
        hint: "Odusphereを終了してもデーモンは実行し続けます",
      },
      logs: {
        title: "ログファイル",
        modalTitle: "デーモンログ",
    ...
    rosetta: {
      ...
      runningIntel: "Apple Silicon上のRosettaでOdusphereのIntelビルドを実行しています。",
      highCpu:
    ...
    integrations: {
      cli: {
        ...
        installFailed: "Odusphere CLIをインストールできません。",
      },
    },
  },
  rootError: {
    title: "Odusphere で問題が発生しました。",
  ...
  pairing: {
    ...
    direct: {
      title: "直接接続",
      helper: "Odusphereサーバーのアドレスを入力してください。",
      fields: {
        host: "ホスト",
        port: "ポート",
        password: "パスワード",
    ...
    remoteSsh: {
      title: "リモート SSH",
      helper: "リモートホストで動作する Odusphere デーモンに接続します。",
      fields: {
        target: "SSH ホスト",
      },
      actions: {
    ...
    device: {
      ...
      relayDocs: "リレーの仕組み",
      relayDocsAccessibility: "Odusphere リレーの仕組みを読む",
      enableRelay: "リレーを有効にする",
      enablingRelay: "有効化中...",
      notNow: "今はしない",
      directConnectionHint:
        "リレーを使わない場合は、TCP、Tailscale、または別の VPN で直接接続してください。QR コードは作成されません。",
      updateRequired: "Odusphere Desktop からリレーを有効にするにはホストを更新してください。",
      unavailable: "ペアリングオファーが利用できません。",
      hint: "スマートフォンのOdusphereでこのQRコードをスキャンするか、以下のリンクをコピーしてください。",
      securityWarning:
  ...
  toolCallGroup: {
    ...
    paseoCalls: {
      one: "Odusphereを{{count}}回呼び出し",
      other: "Odusphereを{{count}}回呼び出し",
    },
    and: "および",
  },
  renameModal: {
  ...
  settings: {
    ...
    notifications: {
      ...
      sentDescription: "Odusphere が通知をオペレーティングシステムに渡しました。",
    ...
    metadataGeneration: {
      ...
      automatic: "自動",
      preferred: "手動",
      automaticHint: "Odusphere が利用可能な高速モデルを選択します",
      preferredHint: "Odusphere が使用するモデルを選択します",
      model: "モデル",
      fallbackHint: "利用できない場合、Odusphere は別の利用可能なモデルを使用します",
      docs: "ドキュメント",
    ...
    about: {
      ...
      updates: {
        ...
        installMessage: "このコンピューターのOdusphereを更新します",
    ...
    host: {
      ...
      skills: {
        ...
        updateTitle: "Odusphereスキルを更新しますか？",
        updateFallback: "バンドルされたスキルをマシンに同期します。",
        uninstallTitle: "Odusphereスキルをアンインストールしますか？",
        uninstallMessage:
          "~/.agents、~/.claude、~/.codexからすべてのOdusphereオーケストレーションスキルを削除します。",
        choose: "スキルを選択",
        chooseAll: "すべてのスキル",
        chooseAllHint:
      ...
      orchestration: {
        ...
        enableTools: {
          title: "Odusphereツールを有効にする",
          hint: "エージェントがワークツリー、エージェント、スケジュールを管理できるようになります",
          accessibilityLabel: "Odusphereツールを有効にする",
        },
        systemPrompt: {
          title: "システムプロンプト",
      ...
      daemon: {
        ...
        restart: {
          ...
          offlineMessage:
            "このホストはオフラインです。Odusphereが自動再接続します。再起動は、ホストがオンラインに戻ってから行ってください。",
          requestFailedTitle: "エラー",
          requestFailedMessage:
            "再起動リクエストの送信に失敗しました。Odusphereは自動的に再接続します。ホストがオンラインになったら再試行してください。",
          dialogFailedMessage: "再起動確認ダイアログを開けませんでした。",
        },
        update: {
          desktopManagedHint:
            "このデーモンはOdusphere Desktopによって管理されています。ホスト上のOdusphere Desktopを更新してください。",
          title: "デーモンを更新",
    ...
    project: {
      ...
      scripts: {
        ...
        serviceHint: "Odusphereがプロセスを監督し、$PASEO_PORTを通じてポートを割り当てます",
        actions: {
          add: "スクリプトを追加",
          edit: "編集",
          remove: "削除",
      ...
      metadata: {
        title: "メタデータ生成",
        info: "Odusphereがメタデータ生成に使うAIプロンプトへ追加する、プロジェクト固有の指示です。ブランチ名、コミット形式、PR形式など、チームの規約を反映するために使います。",
        branchName: "ブランチ名",
