...
export const es: TranslationResources = {
  ...
  agentStream: {
    ...
    find: {
      ...
      open: "Buscar en la sesión",
      close: "Cerrar búsqueda",
      next: "Coincidencia siguiente",
      previous: "Coincidencia anterior",
      count: "{{position}} de {{total}}",
      countTruncated: "{{position}} de {{total}}+",
      noMatches: "Sin coincidencias",
      failed: "La búsqueda falló",
      kind: {
        user_message: "Tú",
        assistant_message: "Agente",
    ...
    git: {
      actions: {
        ...
        unavailable: {
          ...
          archiveNotWorktree:
            "El archivo no está disponible aquí porque este espacio de trabajo no se creó como un árbol de trabajoOdusphere",
          mergePrNoForge:
  ...
  desktop: {
    ...
    daemon: {
      ...
      management: {
        ...
        hint: "Deje queOdusphereinicie y detenga el demonio incorporado",
        ...
        pausedStopFailed:
          "La gestión del demonio integrado se pausó, peroOdusphereno pudo detener el demonio.",
      ...
      keepRunning: {
        ...
        hint: "Daemonsigue ejecutándose cuando sales deOdusphere",
      },
      logs: {
    ...
    rosetta: {
      ...
      runningIntel: "Estás ejecutando la compilaciónInteldeOdusphereenRosettaenApple Silicon.",
      highCpu:
    ...
    permissions: {
      ...
      testNotification: {
        title: "Prueba de notificaciónOdusphere",
    ...
    integrations: {
      cli: {
        ...
        installFailed: "No se puede instalar elOdusphereCLI.",
      },
    },
  },
  rootError: {
    title: "Odusphere tuvo un problema.",
  ...
  pairing: {
    ...
    direct: {
      title: "Conexión directa",
      helper: "Ingrese la dirección de un servidorOdusphere.",
      fields: {
        host: "Host",
        port: "Puerto",
        password: "Contraseña",
    ...
    remoteSsh: {
      title: "SSH remoto",
      helper: "Conéctate a un daemon de Odusphere en el host remoto.",
      fields: {
        target: "Host SSH",
      },
      actions: {
    ...
    device: {
      ...
      relayDocsAccessibility: "Leer cómo funciona el relé de Odusphere",
      ...
      updateRequired: "Actualice el host para habilitar el relé desde Odusphere Desktop.",
      unavailable: "Oferta de maridaje no disponible.",
      hint: "Escanee este códigoQRconOdusphereen su teléfono o copie el enlace a continuación.",
      securityWarning:
  ...
  toolCallGroup: {
    ...
    paseoCalls: {
      one: "llamó a Odusphere {{count}} vez",
      other: "llamó a Odusphere {{count}} veces",
    },
    and: "y",
  },
  renameModal: {
  ...
  settings: {
    ...
    notifications: {
      ...
      sentDescription: "Odusphere entregó la notificación al sistema operativo.",
    ...
    metadataGeneration: {
      ...
      description:
        "Elige el modelo que Odusphere usa para títulos de espacios de trabajo, nombres de ramas, mensajes de commit y borradores de pull requests",
      selection: "Selección de modelo",
      automatic: "Automática",
      preferred: "Manual",
      automaticHint: "Odusphere elige un modelo rápido disponible",
      preferredHint: "Elige el modelo que usa Odusphere",
      model: "Modelo",
      fallbackHint: "Si no está disponible, Odusphere usa otro modelo disponible",
      docs: "Documentación",
    ...
    general: {
      ...
      browserData: {
        ...
        description:
          "Las pestañas del navegador comparten inicios de sesión y datos de sitios en Odusphere.",
    ...
    about: {
      ...
      updates: {
        ...
        installMessage: "Esto actualizaOdusphereen esta computadora.",
    ...
    shortcuts: {
      ...
      help: {
        ...
        findInSession: "Buscar en la sesión",
    ...
    host: {
      ...
      skills: {
        ...
        updateTitle: "¿Actualizar las habilidades deOdusphere?",
        updateFallback: "Sincronice las habilidades incluidas con su máquina.",
        uninstallTitle: "¿Desinstalar las habilidadesOdusphere?",
        uninstallMessage:
          "Elimina todas las habilidades de orquestaciónOduspherede ~/.agents, ~/.claude, ~/.codex.",
      ...
      orchestration: {
        ...
        enableTools: {
          title: "Habilitar herramientasOdusphere",
          hint: "Los agentes podrán gestionar árboles de trabajo, agentes y horarios.",
          accessibilityLabel: "Inyectar herramientasOdusphere",
        },
        systemPrompt: {
      ...
      daemon: {
        ...
        restart: {
          ...
          offlineMessage:
            "Este anfitrión está desconectado.Oduspherese vuelve a conectar automáticamente; espere hasta que vuelva a estar en línea antes de reiniciar.",
          requestFailedTitle: "Error",
          requestFailedMessage:
            "No se pudo enviar la solicitud de reinicio.Oduspherese vuelve a conectar automáticamente; inténtelo nuevamente una vez que el host se muestre en línea.",
          dialogFailedMessage:
            "No se puede abrir el cuadro de diálogo de confirmación de reinicio.",
        },
        update: {
          desktopManagedHint:
            "Este daemon está administrado por Odusphere Desktop. Actualiza Odusphere Desktop en el host.",
          title: "Update daemon",
    ...
    project: {
      ...
      scripts: {
        ...
        serviceHint: "Oduspheresupervisa el proceso y asigna un puerto vía $PASEO_PORT",
        actions: {
          add: "Agregar guión",
          edit: "Editar",
          remove: "Eliminar",
      ...
      metadata: {
        title: "Generación de metadatos",
        info: "Instrucciones específicas del proyecto inyectadas en los mensajes de IA queOdusphereutiliza para generar metadatos; úselas para hacer cumplir las convenciones de su equipo, como la denominación de ramas, el estilo de confirmación o el formatoPR.",
