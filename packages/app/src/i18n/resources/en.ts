export const en = {
  ...
  agentStream: {
    ...
    find: {
      ...
      open: "Find in session",
      close: "Close find",
      next: "Next match",
      previous: "Previous match",
      count: "{{position}} of {{total}}",
      countTruncated: "{{position}} of {{total}}+",
      noMatches: "No matches",
    ...
    git: {
      actions: {
        ...
        unavailable: {
          ...
          archiveNotWorktree:
            "Archive isn't available here because this workspace was not created as an Odusphere worktree",
          mergePrNoForge:
  ...
  desktop: {
    ...
    daemon: {
      ...
      management: {
        ...
        hint: "Let Odusphere start and stop the built-in daemon",
        ...
        pausedStopFailed:
          "Built-in daemon management was paused, but Odusphere could not stop the daemon.",
        updateFailed: "Unable to update built-in daemon management.",
      },
      keepRunning: {
        title: "Keep daemon running after quit",
        hint: "Daemon keeps running when you quit Odusphere",
      },
      logs: {
        title: "Log file",
    ...
    rosetta: {
      ...
      runningIntel: "You're running the Intel build of Odusphere under Rosetta on Apple Silicon.",
    ...
    permissions: {
      ...
      testNotification: {
        title: "Odusphere notification test",
    ...
    integrations: {
      cli: {
        ...
        installFailed: "Unable to install the Odusphere CLI.",
      },
    },
  },
  rootError: {
    title: "Odusphere ran into a problem.",
  ...
  pairing: {
    ...
    direct: {
      title: "Direct connection",
      helper: "Enter the address of an Odusphere server.",
      fields: {
        host: "Host",
        port: "Port",
        password: "Password",
    ...
    remoteSsh: {
      title: "Remote SSH",
      helper: "Connect to an Odusphere daemon running on the remote host.",
      fields: {
        target: "SSH host",
      },
      actions: {
    ...
    device: {
      ...
      relayDocsAccessibility: "Read how Odusphere relay works",
      ...
      updateRequired: "Update the host to enable relay from Odusphere Desktop.",
      unavailable: "Pairing offer unavailable.",
      hint: "Scan this QR code with Odusphere on your phone, or copy the link below.",
      securityWarning:
  ...
  toolCallGroup: {
    ...
    paseoCalls: {
      one: "called Odusphere {{count}} time",
      other: "called Odusphere {{count}} times",
    },
    and: "and",
  },
  renameModal: {
  ...
  settings: {
    ...
    notifications: {
      ...
      sentDescription: "Odusphere handed the notification to the operating system.",
    ...
    metadataGeneration: {
      ...
      description:
        "Choose the model Odusphere uses for workspace titles, branch names, commit messages, and pull request drafts",
      selection: "Model selection",
      automatic: "Automatic",
      preferred: "Manual",
      automaticHint: "Odusphere picks a fast available model",
      preferredHint: "Choose the model Odusphere uses",
      model: "Model",
      fallbackHint: "If it is unavailable, Odusphere falls back to another available model",
      docs: "Docs",
    ...
    general: {
      ...
      browserData: {
        ...
        description: "Browser tabs share sign-ins and site data across Odusphere.",
    ...
    about: {
      ...
      updates: {
        ...
        installMessage: "This updates Odusphere on this computer",
    ...
    host: {
      ...
      skills: {
        ...
        updateTitle: "Update Odusphere skills?",
        updateFallback: "Sync bundled skills to this host.",
        uninstallTitle: "Uninstall Odusphere skills?",
        uninstallMessage:
          "Removes all Odusphere orchestration skills from ~/.agents, ~/.claude, ~/.codex on this host.",
      ...
      orchestration: {
        ...
        enableTools: {
          title: "Enable Odusphere tools",
          hint: "Agents will be able to manage worktrees, agents and schedules",
          accessibilityLabel: "Inject Odusphere tools",
        },
        systemPrompt: {
          title: "System prompt",
      ...
      daemon: {
        ...
        restart: {
          ...
          offlineMessage:
            "This host is offline. Odusphere reconnects automatically-wait until it's back online before restarting.",
          requestFailedTitle: "Error",
          requestFailedMessage:
            "Failed to send the restart request. Odusphere reconnects automatically-try again once the host shows as online.",
    ...
    project: {
      ...
      scripts: {
        ...
        serviceHint: "Odusphere supervises the process and assigns a port via $PASEO_PORT",
        actions: {
          add: "Add script",
          edit: "Edit",
          remove: "Remove",
      ...
      metadata: {
        title: "Metadata generation",
        info: "Project-specific instructions injected into the AI prompts Odusphere uses to generate metadata - use them to enforce your team's conventions like branch naming, commit style, or PR format",
