...
export const ko: TranslationResources = {
  ...
  agentStream: {
    ...
    find: {
      ...
      next: "다음 일치 항목",
      previous: "이전 일치 항목",
      count: "{{total}}개 중 {{position}}개",
      countTruncated: "{{total}}+개 중 {{position}}개",
      noMatches: "일치 항목 없음",
      failed: "검색 실패",
      kind: {
        user_message: "나",
        assistant_message: "에이전트",
        reasoning: "사고",
        error: "오류",
        tool_call: "도구 호출",
      },
    ...
    git: {
      actions: {
        ...
        unavailable: {
          ...
          archiveNotWorktree:
            "이 워크스페이스가 Odusphere 워크트리로 생성되지 않아 여기서 보관을 사용할 수 없습니다",
          mergePrNoForge:
  ...
  desktop: {
    ...
    daemon: {
      ...
      management: {
        title: "내장 데몬 관리",
        hint: "Odusphere가 내장 데몬을 시작하고 중지하도록 허용합니다",
        pauseTitle: "내장 데몬 일시 중지",
        pauseMessage:
          "내장 데몬이 즉시 중지됩니다. 내장 데몬에 연결된 실행 중인 에이전트와 터미널이 중지됩니다.",
        pauseAndStop: "일시 중지 후 중지",
        registrationFailed:
          "내장 데몬이 시작되었지만 Odusphere가 localhost 연결을 저장하지 못했습니다. 데몬 관리를 껐다가 다시 켜거나 localhost를 수동으로 추가하세요.",
        pausedStopFailed:
          "내장 데몬 관리가 일시 중지되었지만 Odusphere가 데몬을 중지하지 못했습니다.",
        updateFailed: "내장 데몬 관리를 업데이트할 수 없습니다.",
      },
      keepRunning: {
        title: "종료 후에도 데몬 계속 실행",
        hint: "Odusphere를 종료해도 데몬이 계속 실행됩니다",
      },
      logs: {
        title: "로그 파일",
        modalTitle: "데몬 로그",
    ...
    rosetta: {
      ...
      runningIntel: "Apple Silicon에서 Rosetta로 Odusphere의 Intel 빌드를 실행하고 있습니다.",
      highCpu:
    ...
    integrations: {
      cli: {
        ...
        installFailed: "Odusphere CLI를 설치할 수 없습니다.",
      },
    },
  },
  rootError: {
    title: "Odusphere에 문제가 발생했습니다.",
  ...
  pairing: {
    ...
    direct: {
      title: "직접 연결",
      helper: "Odusphere 서버의 주소를 입력하세요.",
      fields: {
        host: "호스트",
        port: "포트",
        password: "비밀번호",
    ...
    remoteSsh: {
      title: "원격 SSH",
      helper: "원격 호스트에서 실행 중인 Odusphere 데몬에 연결합니다.",
      fields: {
        target: "SSH 호스트",
      },
      actions: {
    ...
    device: {
      ...
      relayDocs: "릴레이 작동 방식",
      relayDocsAccessibility: "Odusphere 릴레이 작동 방식 읽기",
      enableRelay: "릴레이 활성화",
      enablingRelay: "활성화 중...",
      notNow: "지금은 아님",
      directConnectionHint:
        "릴레이 없이 TCP, Tailscale 또는 다른 VPN을 통해 직접 연결하세요. QR 코드가 생성되지 않습니다.",
      updateRequired: "Odusphere 데스크톱에서 릴레이를 활성화하려면 호스트를 업데이트하세요.",
      unavailable: "페어링 정보를 사용할 수 없습니다.",
      hint: "휴대폰의 Odusphere로 이 QR 코드를 스캔하거나 아래 링크를 복사하세요.",
      securityWarning:
  ...
  toolCallGroup: {
    ...
    paseoCalls: {
      one: "Odusphere를 {{count}}회 호출함",
      other: "Odusphere를 {{count}}회 호출함",
    },
    and: "그리고",
  },
  renameModal: {
  ...
  settings: {
    ...
    notifications: {
      ...
      sentDescription: "Odusphere가 알림을 운영 체제에 전달했습니다.",
    ...
    metadataGeneration: {
      ...
      automatic: "자동",
      preferred: "수동",
      automaticHint: "Odusphere가 사용 가능한 빠른 모델을 선택합니다",
      preferredHint: "Odusphere에서 사용할 모델을 선택하세요",
      model: "모델",
      fallbackHint: "사용할 수 없으면 Odusphere가 다른 사용 가능한 모델을 사용합니다",
      docs: "문서",
    ...
    general: {
      ...
      browserData: {
        ...
        description: "브라우저 탭은 Odusphere 전체에서 로그인 및 사이트 데이터를 공유합니다.",
        clear: "브라우저 데이터 지우기",
        clearing: "삭제 중...",
    ...
    about: {
      ...
      updates: {
        ...
        installMessage: "이 컴퓨터의 Odusphere를 업데이트합니다",
    ...
    host: {
      ...
      skills: {
        ...
        updateTitle: "Odusphere 스킬을 업데이트할까요?",
        updateFallback: "번들된 스킬을 내 컴퓨터에 동기화합니다.",
        uninstallTitle: "Odusphere 스킬을 제거할까요?",
        uninstallMessage:
          "~/.agents, ~/.claude, ~/.codex에서 모든 Odusphere 오케스트레이션 스킬을 제거합니다.",
        choose: "스킬 선택",
        chooseAll: "모든 스킬",
      ...
      orchestration: {
        ...
        enableTools: {
          title: "Odusphere 도구 활성화",
          hint: "에이전트가 워크트리, 에이전트, 일정을 관리할 수 있습니다",
          accessibilityLabel: "Odusphere 도구 주입",
        },
        systemPrompt: {
          title: "시스템 프롬프트",
      ...
      daemon: {
        ...
        restart: {
          ...
          offlineMessage:
            "이 호스트는 오프라인입니다. Odusphere가 자동으로 다시 연결하므로 다시 온라인이 될 때까지 기다린 후 재시작하세요.",
          requestFailedTitle: "오류",
          requestFailedMessage:
            "재시작 요청을 보내지 못했습니다. Odusphere가 자동으로 다시 연결하므로 호스트가 온라인으로 표시되면 다시 시도하세요.",
          dialogFailedMessage: "재시작 확인 대화 상자를 열 수 없습니다.",
        },
        update: {
          desktopManagedHint:
            "이 데몬은 Odusphere Desktop에서 관리됩니다. 호스트에서 Odusphere 데스크톱을 업데이트합니다.",
          title: "데몬 업데이트",
    ...
    project: {
      ...
      scripts: {
        ...
        serviceHint: "Odusphere가 프로세스를 감독하고 $PASEO_PORT를 통해 포트를 할당합니다",
        actions: {
          add: "스크립트 추가",
          edit: "편집",
          remove: "제거",
      ...
      metadata: {
        title: "메타데이터 생성",
        info: "Odusphere가 메타데이터를 생성하는 데 사용하는 AI 프롬프트에 주입되는 프로젝트별 지침 - 브랜치 이름, 커밋 스타일, PR 형식 같은 팀 규칙을 적용하는 데 사용하세요",
        branchName: "브랜치 이름",
