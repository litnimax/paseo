...
export const ko: TranslationResources = {
  ...
  settings: {
    ...
    about: {
      ...
      automaticUpdates: {
        label: "자동 업데이트",
        description: "백그라운드에서 확인하고 새 버전이 준비되면 알림을 표시합니다",
      },
      updates: {
        label: "앱 업데이트",
    ...
    project: {
      ...
      branching: {
        title: "브랜치 생성",
        info: "새 워크스페이스를 만들 때 다른 브랜치를 고르지 않으면 이 브랜치에서 분기합니다",
        baseBranch: "기본 베이스 브랜치",
        baseBranchAccessibility: "기본 베이스 브랜치",
        baseBranchPlaceholder: "프로젝트의 현재 브랜치",
      },
      worktree: {
        title: "워크트리 수명 주기 훅",
