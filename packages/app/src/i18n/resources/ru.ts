...
export const ru: TranslationResources = {
    ...
    git: {
      actions: {
        ...
        unavailable: {
          ...
          archiveNotWorktree:
            "Архивирование недоступно: это рабочее пространство не было создано как worktree Odusphere.",
  ...
  desktop: {
    ...
    quitting: {
      title: "Завершение работы Odusphere...",
    ...
    daemon: {
      ...
      management: {
        ...
        hint: "Разрешить Odusphere запускать и останавливать встроенный демон",
        ...
        registrationFailed:
          "Встроенный демон запущен, но Odusphere не удалось сохранить подключение к localhost. Выключите и снова включите управление демоном или добавьте localhost вручную.",
        pausedStopFailed:
          "Встроенное управление демоном было приостановлено, но Odusphere не смог остановить демон.",
        updateFailed: "Не удалось изменить настройки управления встроенным демоном.",
      },
      keepRunning: {
        title: "Продолжать работу демона после выхода",
        hint: "Демон продолжит работать после выхода из Odusphere",
      },
      logs: {
        title: "Файл журнала",
    ...
    rosetta: {
      ...
      runningIntel: "Вы используете сборку Odusphere для Intel через Rosetta на Apple Silicon.",
      highCpu:
    ...
    permissions: {
      ...
      testNotification: {
        title: "Тест уведомлений Odusphere",
    ...
    integrations: {
      cli: {
        ...
        installFailed: "Не удалось установить Odusphere CLI.",
      },
    },
  },
  rootError: {
    title: "В Odusphere возникла проблема.",
  ...
  onboarding: {
    title: "Добро пожаловать в Odusphere",
  ...
  pairing: {
    ...
    direct: {
      title: "Прямое подключение",
      helper: "Введите адрес сервера Odusphere.",
      fields: {
        host: "Хост",
        port: "Порт",
        password: "Пароль",
    ...
    remoteSsh: {
      title: "Удалённый SSH",
      helper: "Подключитесь к демону Odusphere на удалённом хосте.",
      fields: {
        target: "Хост SSH",
      },
      actions: {
    ...
    device: {
      ...
      relayDocsAccessibility: "Узнать, как работает ретранслятор Odusphere",
      ...
      updateRequired: "Обновите хост, чтобы включить ретранслятор из Odusphere Desktop.",
      unavailable: "Данные для сопряжения недоступны.",
      hint: "Отсканируйте этот QR-код с помощью Odusphere на телефоне или скопируйте ссылку ниже.",
      securityWarning:
  ...
  toolCallGroup: {
    ...
    paseoCalls: {
      one: "выполнен {{count}} вызов Odusphere",
      other: "выполнены вызовы Odusphere ({{count}})",
    },
    and: "и",
  },
  renameModal: {
  ...
  settings: {
    ...
    notifications: {
      ...
      sentDescription: "Odusphere передал уведомление операционной системе.",
    ...
    metadataGeneration: {
      ...
      description:
        "Выберите модель, которую Odusphere будет использовать для названий рабочих пространств и веток, сообщений коммитов и черновиков PR",
      selection: "Выбор модели",
      automatic: "Автоматически",
      preferred: "Вручную",
      automaticHint: "Odusphere выбирает быструю доступную модель",
      preferredHint: "Выберите модель, которую использует Odusphere",
      model: "Модель",
      fallbackHint: "Если она недоступна, Odusphere использует другую доступную модель",
      docs: "Документация",
    ...
    general: {
      ...
      browserData: {
        ...
        description: "Вкладки браузера в Odusphere используют общие данные входа и данные сайтов.",
      ...
      reviewModel: {
        ...
        description:
          "Модель, используемая при запуске ревью в новом чате. Оставьте пустым, чтобы использовать модель workspace по умолчанию.",
    ...
    about: {
      ...
      releaseChannel: {
        label: "Канал выпуска",
        description:
          "Переключитесь на бета-канал, чтобы раньше получать обновления и помогать развивать Odusphere.",
        stable: "Стабильный",
        beta: "Бета",
      },
      updates: {
        ...
        installMessage: "Это обновит Odusphere на этом компьютере.",
    ...
    host: {
      ...
      teamMembers: {
        sectionTitle: "Участник команды",
        hint: "Выберите, кто использует это устройство. Новые рабочие области и операции Git будут использовать эту личность.",
        empty: "Добавьте daemon.teamMembers в конфигурацию хоста, затем выберите участника здесь.",
        unsupported: "Обновите хост, чтобы использовать личности участников команды.",
        unassigned: "Не назначен",
        selectionFailed: "Не удалось изменить участника команды",
      },
      connections: {
        title: "Подключения",
      ...
      skills: {
        ...
        updateTitle: "Обновить навыки Odusphere?",
        updateFallback: "Встроенные навыки будут синхронизированы с этим хостом.",
        uninstallTitle: "Удалить навыки Odusphere?",
        uninstallMessage:
          "Удаляет все навыки оркестрации Odusphere из ~/.agents, ~/.claude и ~/.codex на этом хосте.",
      ...
      orchestration: {
        ...
        enableTools: {
          title: "Включить инструменты Odusphere",
          hint: "Агенты смогут управлять worktree, агентами и расписаниями.",
          accessibilityLabel: "Добавить инструменты Odusphere",
        },
        systemPrompt: {
      ...
      daemon: {
        ...
        restart: {
          ...
          offlineMessage:
            "Этот хост не в сети. Odusphere переподключится автоматически. Дождитесь подключения перед перезапуском.",
          requestFailedTitle: "Ошибка",
          requestFailedMessage:
            "Не удалось отправить запрос на перезапуск. Odusphere переподключается автоматически. Повторите попытку, когда хост появится в сети.",
          dialogFailedMessage: "Не удалось открыть диалог подтверждения перезапуска.",
        },
        update: {
          desktopManagedHint:
            "Этот демон управляется Odusphere Desktop. Обновите Odusphere Desktop на хосте.",
    ...
    project: {
      ...
      scripts: {
        ...
        serviceHint: "Odusphere управляет процессом и назначает порт через переменную $PASEO_PORT.",
        actions: {
          add: "Добавить скрипт",
          edit: "Редактировать",
          remove: "Удалить",
      ...
      metadata: {
        title: "Генерация метаданных",
        info: "Инструкции для этого проекта, добавляемые в промпты ИИ, с помощью которых Odusphere генерирует метаданные. Используйте их, чтобы соблюдать принятые в команде правила именования веток, оформления коммитов и формата PR.",
