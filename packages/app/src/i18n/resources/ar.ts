...
export const ar: TranslationResources = {
  ...
  agentStream: {
    ...
    find: {
      placeholder: "البحث في الجلسة",
      open: "البحث في الجلسة",
      close: "إغلاق البحث",
      next: "النتيجة التالية",
      previous: "النتيجة السابقة",
      count: "{{position}} من {{total}}",
      countTruncated: "{{position}} من {{total}}+",
      noMatches: "لا توجد نتائج",
      failed: "فشل البحث",
      kind: {
        user_message: "أنت",
        assistant_message: "الوكيل",
        reasoning: "التفكير",
        error: "خطأ",
    ...
    git: {
      actions: {
        ...
        unavailable: {
          ...
          archiveNotWorktree:
            "الأرشيف غير متاح هنا لأنه لم يتم إنشاء مساحة العمل هذه كشجرة عمل Odusphere",
  ...
  desktop: {
    ...
    daemon: {
      ...
      management: {
        ...
        hint: "اسمح لـ Odusphere ببدء تشغيل البرنامج الخفي المدمج وإيقافه",
        ...
        pausedStopFailed:
          "تم إيقاف إدارة البرنامج الخفي المضمنة مؤقتًا، لكن لم يتمكن Odusphere من إيقاف البرنامج الخفي.",
        updateFailed: "غير قادر على تحديث إدارة البرنامج الخفي المضمنة.",
      },
      keepRunning: {
        title: "استمر في تشغيل البرنامج الخفي بعد الإقلاع عن التدخين",
        hint: "يستمر تشغيل Daemon عند إنهاء Odusphere",
      },
      logs: {
        title: "ملف السجل",
    ...
    rosetta: {
      ...
      runningIntel: "أنت تقوم بتشغيل إصدار Intel من Odusphere ضمن Rosetta على Apple Silicon.",
      highCpu:
    ...
    permissions: {
      ...
      testNotification: {
        title: "اختبار الإخطار Odusphere",
    ...
    integrations: {
      cli: {
        ...
        installFailed: "غير قادر على تثبيت OdusphereCLI.",
      },
    },
  },
  rootError: {
    title: "واجه Odusphere مشكلة.",
  ...
  pairing: {
    ...
    direct: {
      title: "اتصال مباشر",
      helper: "أدخل عنوان خادم Odusphere.",
      fields: {
        host: "Host",
        port: "ميناء",
    ...
    remoteSsh: {
      title: "SSH عن بُعد",
      helper: "الاتصال بخادم Odusphere يعمل على المضيف البعيد.",
      fields: {
        target: "مضيف SSH",
      },
      actions: {
    ...
    device: {
      ...
      relayDocsAccessibility: "اقرأ كيفية عمل تتابع Odusphere",
      ...
      updateRequired: "حدّث المضيف لتمكين التتابع من Odusphere Desktop.",
      unavailable: "عرض الاقتران غير متاح.",
      hint: "قم بمسح رمز QR هذا باستخدام Odusphere على هاتفك، أو انسخ الرابط أدناه.",
      securityWarning:
  ...
  toolCallGroup: {
    ...
    paseoCalls: {
      one: "استدعى Odusphere {{count}} مرة",
      other: "استدعى Odusphere {{count}} مرات",
    },
    and: "و",
  },
  renameModal: {
  ...
  settings: {
    ...
    notifications: {
      ...
      sentDescription: "سلّم Odusphere الإشعار إلى نظام التشغيل.",
    ...
    metadataGeneration: {
      ...
      description:
        "اختر النموذج الذي يستخدمه Odusphere لعناوين مساحات العمل وأسماء الفروع ورسائل الالتزام ومسودات طلبات السحب",
      selection: "اختيار النموذج",
      automatic: "تلقائي",
      preferred: "يدوي",
      automaticHint: "يختار Odusphere نموذجًا سريعًا متاحًا",
      preferredHint: "اختر النموذج الذي يستخدمه Odusphere",
      model: "النموذج",
      fallbackHint: "إذا لم يكن متاحًا، يستخدم Odusphere نموذجًا آخر متاحًا",
      docs: "الوثائق",
    ...
    general: {
      ...
      browserData: {
        ...
        description: "تتشارك علامات تبويب المتصفح تسجيلات الدخول وبيانات المواقع عبر Odusphere.",
      ...
      reviewModel: {
        ...
        description:
          "النموذج المستخدم عند بدء مراجعة في محادثة جديدة. اتركه بدون تحديد لاستخدام الإعداد الافتراضي لمساحة العمل.",
    ...
    about: {
      ...
      updates: {
        ...
        installMessage: "يؤدي هذا إلى تحديث Odusphere على هذا الكمبيوتر",
    ...
    host: {
      ...
      skills: {
        ...
        updateTitle: "تحديث مهارات Odusphere ؟",
        updateFallback: "مزامنة المهارات المجمعة لجهازك.",
        uninstallTitle: "إلغاء تثبيت مهارات Odusphere ؟",
        uninstallMessage: "يزيل جميع مهارات تنسيق Odusphere من ~/.agents ، ~/.claude ، ~/.codex.",
      ...
      daemon: {
        ...
        restart: {
          ...
          offlineMessage:
            "هذا المضيف غير متصل.  يقوم Odusphere بإعادة الاتصال تلقائيًا - انتظر حتى يتم الاتصال بالإنترنت مرة أخرى قبل إعادة التشغيل.",
          requestFailedTitle: "خطأ",
          requestFailedMessage:
            "فشل في إرسال طلب إعادة التشغيل.  يقوم Odusphere بإعادة الاتصال تلقائيًا - حاول مرة أخرى بمجرد ظهور المضيف على أنه متصل بالإنترنت.",
          dialogFailedMessage: "غير قادر على فتح مربع حوار تأكيد إعادة التشغيل.",
        },
        update: {
          desktopManagedHint:
            "يدير Odusphere Desktop هذا البرنامج الخفي. حدّث Odusphere Desktop على المضيف.",
          title: "Update daemon",
    ...
    project: {
      ...
      scripts: {
        ...
        serviceHint: "يشرف Odusphere على العملية ويعين منفذًا عبر $PASEO_PORT",
        actions: {
      ...
      metadata: {
        ...
        info: "تعليمات خاصة بالمشروع يتم إدخالها في الذكاء الاصطناعي الذي يستخدمه Odusphere لإنشاء بيانات التعريف - استخدمها لفرض اصطلاحات فريقك مثل تسمية الفرع أو نمط الالتزام أو تنسيق PR",
