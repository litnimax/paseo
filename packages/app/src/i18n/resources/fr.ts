...
export const fr: TranslationResources = {
  ...
  agentStream: {
    ...
    find: {
      ...
      open: "Rechercher dans la session",
      close: "Fermer la recherche",
      next: "Correspondance suivante",
      previous: "Correspondance précédente",
      count: "{{position}} sur {{total}}",
      countTruncated: "{{position}} sur {{total}}+",
      noMatches: "Aucune correspondance",
    ...
    git: {
      actions: {
        ...
        unavailable: {
          ...
          archiveNotWorktree:
            "L'archive n'est pas disponible ici car cet espace de travail n'a pas été créé en tant qu'arbre de travailOdusphere",
          mergePrNoForge:
  ...
  desktop: {
    ...
    daemon: {
      ...
      management: {
        ...
        hint: "LaissezOduspheredémarrer et arrêter le démon intégré",
        ...
        pausedStopFailed:
          "La gestion du démon intégré a été suspendue, maisOduspheren'a ​​pas pu arrêter le démon.",
      ...
      keepRunning: {
        ...
        hint: "Daemoncontinue de fonctionner lorsque vous quittezOdusphere",
      },
      logs: {
    ...
    rosetta: {
      ...
      runningIntel: "Vous exécutez la versionInteldeOduspheresousRosettasurApple Silicon.",
      highCpu:
    ...
    permissions: {
      ...
      testNotification: {
        title: "Test de notificationOdusphere",
    ...
    integrations: {
      cli: {
        ...
        installFailed: "Impossible d'installer leOdusphereCLI.",
      },
    },
  },
  rootError: {
    title: "Odusphere a rencontré un problème.",
  ...
  pairing: {
    ...
    direct: {
      title: "Connexion directe",
      helper: "Saisissez l'adresse d'un serveurOdusphere.",
      fields: {
        host: "Host",
        port: "Port",
    ...
    remoteSsh: {
      title: "SSH distant",
      helper: "Connectez-vous à un daemon Odusphere sur l’hôte distant.",
      fields: {
        target: "Hôte SSH",
      },
      actions: {
    ...
    device: {
      ...
      relayDocsAccessibility: "Lire comment fonctionne le relais Odusphere",
      ...
      updateRequired: "Mettez à jour l’hôte pour activer le relais depuis Odusphere Desktop.",
      unavailable: "Offre de jumelage indisponible.",
      hint: "Scannez ce codeQRavecOduspheresur votre téléphone ou copiez le lien ci-dessous.",
      securityWarning:
  ...
  toolCallGroup: {
    ...
    paseoCalls: {
      one: "a appelé Odusphere {{count}} fois",
      other: "a appelé Odusphere {{count}} fois",
    },
    and: "et",
  },
  renameModal: {
  ...
  settings: {
    ...
    notifications: {
      ...
      sentDescription: "Odusphere a transmis la notification au système d’exploitation.",
    ...
    metadataGeneration: {
      ...
      description:
        "Choisissez le modèle utilisé par Odusphere pour les titres d’espaces de travail, les noms de branches, les messages de commit et les brouillons de pull request",
      selection: "Sélection du modèle",
      automatic: "Automatique",
      preferred: "Manuel",
      automaticHint: "Odusphere choisit un modèle rapide disponible",
      preferredHint: "Choisissez le modèle utilisé par Odusphere",
      model: "Modèle",
      fallbackHint: "S’il est indisponible, Odusphere utilise un autre modèle disponible",
      docs: "Documentation",
    ...
    general: {
      ...
      browserData: {
        ...
        description:
          "Les onglets du navigateur partagent les connexions et les données des sites dans Odusphere.",
    ...
    about: {
      ...
      updates: {
        ...
        installMessage: "Cela met à jourOduspheresur cet ordinateur",
    ...
    shortcuts: {
      ...
      help: {
        ...
        findInSession: "Rechercher dans la session",
    ...
    host: {
      ...
      skills: {
        ...
        updateTitle: "Mettre à jour les compétencesOdusphere?",
        updateFallback: "Synchronisez les compétences regroupées sur votre machine.",
        uninstallTitle: "Désinstaller les compétencesOdusphere?",
        uninstallMessage:
          "Supprime toutes les compétences d'orchestrationOduspherede ~/.agents, ~/.claude, ~/.codex.",
      ...
      orchestration: {
        ...
        enableTools: {
          title: "Activer les outilsOdusphere",
          hint: "Les agents pourront gérer les arbres de travail, les agents et les horaires",
          accessibilityLabel: "Injecter les outilsOdusphere",
        },
        systemPrompt: {
      ...
      daemon: {
        ...
        restart: {
          ...
          offlineMessage:
            "Cet hôte est hors ligne.Oduspherese reconnecte automatiquement: attendez qu'il soit de nouveau en ligne avant de redémarrer.",
          requestFailedTitle: "Erreur",
          requestFailedMessage:
            "Échec de l'envoi de la demande de redémarrage.Oduspherese reconnecte automatiquement - réessayez une fois que l'hôte apparaît comme en ligne.",
          dialogFailedMessage:
            "Impossible d'ouvrir la boîte de dialogue de confirmation de redémarrage.",
        },
        update: {
          desktopManagedHint:
            "Ce daemon est géré par Odusphere Desktop. Mettez à jour Odusphere Desktop sur l’hôte.",
          title: "Update daemon",
    ...
    project: {
      ...
      scripts: {
        ...
        serviceHint: "Oduspheresupervise le processus et attribue un port via $PASEO_PORT",
        actions: {
      ...
      metadata: {
        title: "Génération de métadonnées",
        info: "Instructions spécifiques au projet injectées dans les invites de l'IA queOdusphereutilise pour générer des métadonnées: utilisez-les pour appliquer les conventions de votre équipe telles que la dénomination des branches, le style de validation ou le formatPR.",
